<footer>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 col-11">
                ...
                <div id="social" class="d-none d-sm-block d-lg-block">
                    ...
                    <img src="views/images/googleplus.png" alt="Google Plus">
                    <img src="views/images/youtube.png" alt="YouTube">
    ...
    <div id="soutien">
        <img src="views/images/regionreunion.jpg" alt="Région Réunion">
        <img src="views/images/departement974.jpg" alt="Département de la Réunion">
        <img src="views/images/irt.jpg" alt="IRT">
    </div>
