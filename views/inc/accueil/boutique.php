    ...
    <div class="container">
        ...
        <div class="row">
            <div class="produit col-lg-4 col-md-12">
                <img src="views/images/planchedesurf.jpg" alt="Planche de surf" class="img-fluid">
            ...
            <div class="produit col-lg-4 col-md-6 d-none d-sm-none d-lg-block">
                <img src="views/images/sacados.jpg" alt="Sac à dos" class="img-fluid">
                <div class="nom_produit">Origami<br /> Sac à dos de surf étache</div>
                <div class="prix">105,99 €</div>
            </div>
            <div class="produit col-lg-4 col-md-6 d-none d-sm-none d-lg-block">
                <img src="views/images/combinaison.jpg" alt="Combinaison de surf" class="img-fluid">
                <div class="nom_produit">Syncro 4/3mm - Combinaison de surf intégrale zip poitrine</div>
                <div class="prix">159,00 €</div>
            </div>
            <div class="produit col-lg-4 col-md-6 d-none d-sm-none d-lg-block">
                <img src="views/images/shortdesurf.jpg" alt="Short de surf" class="img-fluid">
                <div class="nom_produit">Samoa 19</div>
                <div class="prix">65,00 €</div>
            </div>
            <div class="produit col-lg-4 col-md-6 d-none d-sm-none d-lg-block">
                <img src="views/images/bodyboard.jpg" alt="Bodyboard" class="img-fluid">
                <div class="nom_produit">Bodyboard Flood<br /> Dynamx 40" White Lime + Leash</div>
                <div class="prix">65,00 €</div>
            </div>
            <div class="produit col-lg-4 col-md-6 d-none d-sm-none d-lg-block">
                <img src="views/images/lycra.jpg" alt="Lycra à manches longues" class="img-fluid">
